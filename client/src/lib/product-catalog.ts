/**
 * Product Catalog — ALL ASINs verified live on Amazon (April 2026)
 * Tag: spankyspinola-20
 * 60 products, all verified, zero 404s
 */
...
export const PRODUCT_CATALOG: Product[] = [
  ...
  // === BOOKS — MINDFULNESS & SPIRITUALITY ===
  ...
  { name: "The Gifts of Imperfection", asin: "0399592520", category: "books-psychology", tags: ["vulnerability", "shame", "courage", "authenticity", "worthy"], description: "Let go of who you think you should be by Brene Brown" },
  ...
  { name: "LUXOME Luxury Weighted Blanket", asin: "B07QTD2ZVS", category: "weighted-blanket", tags: ["weighted", "blanket", "luxury", "sleep"], description: "Luxury removable cover weighted blanket" },
  ...
  { name: "NOW Magnesium Glycinate 100mg", asin: "B07NWMVMT1", category: "supplements", tags: ["magnesium", "supplement", "mineral", "calm"], description: "Affordable magnesium glycinate by NOW Foods" },
  ...
  { name: "TRIBE ORGANICS Ashwagandha KSM-66", asin: "B07H8LVTY1", category: "supplements", tags: ["ashwagandha", "adaptogen", "stress", "cortisol"], description: "Organic ashwagandha with black pepper for absorption" },
  ...
  { name: "Blue Light Blocking Glasses", asin: "B07W781XWF", category: "environment", tags: ["screen", "blue light", "eye", "digital", "computer", "visual"], description: "Blue light blocking glasses for screen time" },
  { name: "ANRRI Blue Light Blocking Glasses", asin: "B07GRPXNX4", category: "environment", tags: ["blue light", "glasses", "screen", "eye strain"], description: "Lightweight blue light blocking glasses" },
  { name: "MAXJULI Blue Light Blocking Glasses", asin: "B081RLZWG7", category: "environment", tags: ["blue light", "glasses", "computer", "eye"], description: "Stylish blue light blocking glasses" },
